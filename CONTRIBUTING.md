Contributing to SPON Core
============================

The SPON Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SPON Core project, and is not to be
confused with overall SPON Network Protocol consensus changes.

Whether a pull request is merged into SPON Core rests with the project merge
...
Patches that change SPON consensus rules are considerably more involved than
...
Where a patch set proposes to change the SPON consensus, it must have been
...
The project leader is the release manager for each SPON Core release.
