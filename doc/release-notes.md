SPON Core version 2.2.1 is now available from:

  <https://github.com/spon-project/spon/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/spon-project/spon/issues>

Compatibility
==============

SPON Core is extensively tested on multiple operating systems using
...
SPON Core should also work on most other Unix-like systems but is not
...
of Bitcoin that SPON was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/spon-project-translations/).
