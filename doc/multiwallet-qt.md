...
In order to support loading of multiple wallets in spon-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is spon.cpp.
...
Changes to spon.cpp
----------------------
spon.cpp is the entry point into spon-qt, and as such, will require some minor modifications to provide hooks for
