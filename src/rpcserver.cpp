...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Spon features */
        {"spon", "masternode", &masternode, true, true, false},
        {"spon", "masternodelist", &masternodelist, true, true, false},
        {"spon", "mnbudget", &mnbudget, true, true, false},
        {"spon", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"spon", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"spon", "mnsync", &mnsync, true, true, false},
        {"spon", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"spon", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use spond, or the -server option to spon-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> spon-cli " + methodname + " " + args + "\n";
}
