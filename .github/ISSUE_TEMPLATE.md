...
This issue tracker is only for technical issues related to SPON Core.
General SPON questions and/or support requests and are best directed to the [SPON Slack](http://spon.slack.com).
...
### What version of SPON Core are you using?
