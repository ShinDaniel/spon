...
RESOURCES += src/qt/spon.qrc src/qt/spon_locale.qrc

TRANSLATIONS += src/qt/locale/spon_bg.ts \
                src/qt/locale/spon_de.ts \
                src/qt/locale/spon_en.ts \
                src/qt/locale/spon_es.ts \
                src/qt/locale/spon_fi.ts \
                src/qt/locale/spon_fr.ts \
                src/qt/locale/spon_it.ts \
                src/qt/locale/spon_ja.ts \
                src/qt/locale/spon_pl.ts \
                src/qt/locale/spon_pt.ts \
                src/qt/locale/spon_ru.ts \
                src/qt/locale/spon_sk.ts \
                src/qt/locale/spon_sv.ts \
                src/qt/locale/spon_vi.ts \
                src/qt/locale/spon_zh_CN.ts \
                src/qt/locale/spon_zh_TW.ts
